...
dfinal = pd.DataFrame([{ 0: [],1 : []}])
dfinal2=pd.DataFrame(index=[], columns=[0,1])
for i in range(1):
    user1=df[df.In==cd[i]]
#
...
#
# .. your code here ..
    userwt1=user1w[(user1w.CallTime<"17:00:00")]
...
# work, between the midnight and 5pm?
    ...
    midWaySamples = userwt1[midWayClusterIndices]
