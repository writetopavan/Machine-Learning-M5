...
#
# .. your code here ..
X=pd.read_csv('C:\\Users\\juhi\\Documents\\python\\DAT210x-master\\DAT210x-master\\Module3\\Datasets\\wheat.data')
...
# .. your code here ..
y
ordered_satisfaction = ['kama', 'canadian', 'rosa']
...
y
#######y['wheat_type'] = df.wheat_type.astype("category").cat.codes
#######y
#
...
#
# .. your code here ..
A=norm.transform(X_train)
B=pd.DataFrame(A)
A1=norm.transform(X_test)
B1=pd.DataFrame(A1)
