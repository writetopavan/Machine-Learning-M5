...
# .. your code here ..
Zero=[]
df=os.listdir('C:\\Users\\juhi\\Downloads\\free-spoken-digit-dataset-master\\recordings')
for i in range(len(df)):
    sample_rate, audio_data = wavfile.read('C:\\Users\\juhi\\Downloads\\free-spoken-digit-dataset-master\\recordings\\'+df[i])
